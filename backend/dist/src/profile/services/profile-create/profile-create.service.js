...
exports.ProfileCreateService = void 0;
const common_1 = require("@nestjs/common");
const prirsma_service_1 = require("../../../Common/utils/prirsma.service");
let ProfileCreateService = class ProfileCreateService {
    constructor(prismaService) {
        this.prismaService = prismaService;
    }
    createProfile(profileCreateInput) {
        return this.prismaService.profileData.create({
            data: profileCreateInput,
        });
    }
};
ProfileCreateService = __decorate([
...
//# sourceMappingURL=profile-create.service.js.map