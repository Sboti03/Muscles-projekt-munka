...
public class Urls {
    ...
    public final String GET_PROFILE_BY_ID(int id) {
        return String.format("http://34.22.242.178:3000/api/profile/admin/id/%d", id);
    }
    ...
    public final String BLOCK_USER(int id) {
        return String.format("http://34.22.242.178:3000/api/admin/user/block/%d", id);
    }
    public final String UNBLOCK_USER(int id) {
        return String.format("http://34.22.242.178:3000/api/admin/user/unblock/%d", id);
    }
